...
describe('AnypointSelector', () => {
  async function selector1Fixture() {
    return await fixture(`<${tag} selected="item0">
  ...
  async function selector2Fixture() {
    return await fixture(`<${tag} selected="item0" selectable="item">
  ...
  describe('content', function() {
    ...
    it('attribute selected', function() {
  ...
  describe('content with selectable', function() {
    let s2;
    beforeEach(async () => {
